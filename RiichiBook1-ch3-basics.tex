...
\vspace{5pt}
\begin{screen}
\LargeHand{m44p667s123678~z666*}
\vspace{-10pt}What would you discard? \vspace{-5pt}
\end{screen}

\bigskip
\noindent
This hand becomes ready to win if you discard \InlineTile{p6} or \InlineTile{p7}. Let's compare the two choices.
\bi\itemsep.1pt
\i Discard \InlineTile{p6} \hspace{5pt} $\Rightarrow$ you wait for \InlineTile{p5~8} (2 kinds--8 tiles)
\i Discard \InlineTile{p7} \hspace{5pt} $\Rightarrow$ you wait for \InlineTile{m4~p6} (2 kinds--4 tiles)
\ei
Which discard choice is better? Although both of the two choices yield a 2-way wait, waiting for \InlineTile{p5~8} is much better than waiting for \InlineTile{m4~p6}, probabilistically speaking. With the \InlineTile{p5~8} wait, there are four tiles of \InlineTile{p5} and another four tiles of \InlineTile{p8} to win on, leaving at most eight winning tiles.\footnote{Of course, the number of winning tiles could be smaller than eight if some of them have already been discarded.}
With the \InlineTile{m4~p6} wait, on the other hand, you have already used up two tiles of \InlineTile{m4} and two tiles of \InlineTile{p6} yourself, leaving at most four winning tiles. It is clearly better to choose the \InlineTile{p5~8} wait over the \InlineTile{m4~p6} wait, because that will give you a higher probability of winning this hand.
