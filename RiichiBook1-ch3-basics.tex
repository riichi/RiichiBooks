...
{\jap Nakabukure} to kształt zawierający luźny kamień w środku sekwensu, np. \InlineTile{m3445}.
...
Przykładowo, weźmy \InlineTile{m3445} --- tworzy on sewens + {\jap ryanmen} po dobraniu któregokolwiek z \InlineTile{m2356}.

Rozważmy następującą rękę:
\begin{screen}
	\CenteredLargeHand{m3445p4688s135568}
	\vspace{-10pt}Który kamień należy odrzucić?\vspace{-5pt}
\end{screen}
Odrzucenie \InlineTile{m4} w celu rozbicia {\jap nakabukure} jest nieoptymalne.
Zrobienie tego co prawda tymczasowo zwiększa {\jap ukeire}, jednak skończymy z wieloma {\jap kanchan}ami.
Alternatywą jest odrzucenie \InlineTile{s8} w celu zachowania {\jap nakabukure}.
...
\begin{screen}
	\CenteredLargeHand{m3445p23s234z4777~p4}
	\vspace{-15pt}\hfill{\footnotesize{Dobór~~~~~~~~~}}\\
	\vspace{-2pt}Który kamień należy odrzucić?\vspace{-5pt}
\end{screen}
Odrzucenie \InlineTile{z4} w celu zachowania {\jap nakabukure} \InlineTile{m3445} powoduje, że zostajemy z {\jap kanchan}em \InlineTile{m35}, czekając na jeden z {\bf dwóch} pozostałych \InlineTile{m4}.
Lepszym wyjściem jest odrzucenie \InlineTile{m4} --- czekamy wówczas na \InlineTile{z4}.
...
Kombinacja ta składa się z sekwensu oraz luźnego kamienia oddalonego od niego o dwa, np. w kształcie \InlineTile{m3567} mamy luźny \InlineTile{m3} ,,sąsiadujący'' z sekwensem \InlineTile{m567}.
Taki \InlineTile{m3} jest bardziej wartościowy od ,,zwyczajnego'' luźnego kamienia, gdyż akceptuje więcej rodzajów kamieni produkujących niekompletny sekwens lub kształt z trzystronnym czekaniem.
...
\newpage
Mając na uwadze fakt, że \InlineTile{m3} w kształcie \InlineTile{m3567} jest bardziej wartościowy od luźnego \InlineTile{m3}, rozważmy następującą rękę:
\begin{screen}
	\CenteredLargeHand{m378p567s2467z777~p3}
	\vspace{-15pt}\hfill{\footnotesize{Dobór~~~~~~~~~}}\\
	\vspace{-2pt}Który kamień należy odrzucić?\vspace{-5pt}
\end{screen}
\InlineTile{p3} jest teraz częścią kształtu \InlineTile{p3567} --- powinniśmy go zatem zachować i zamiast niego odrzucić luźny \InlineTile{m3}.
...
\InlineTile{m1} w kształcie \InlineTile{m1345} i \InlineTile{m9} w kształcie \InlineTile{m5679} akceptują więcej kamieni od luźnych \InlineTile{m2} czy \InlineTile{m8}, nie wspominając o \InlineTile{m1} i \InlineTile{m9}.
