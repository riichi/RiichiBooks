...
\bi\itemsep.1pt
\i Odrzut \InlineTile{p6} \hspace{5pt} $\Rightarrow$ czekamy na \InlineTile{p5~8} (2 rodzaje--8 kamieni),
\i Odrzut \InlineTile{p7} \hspace{5pt} $\Rightarrow$ czekamy na \InlineTile{m4~p6} (2 rodzaje--4 kamienie).
\ei
